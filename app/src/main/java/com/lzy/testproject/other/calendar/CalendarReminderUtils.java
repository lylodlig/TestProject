...
/**
 * Created by LiZhiyu on 2018/9/4.
 */
public class CalendarReminderUtils {
     ...
     * 添加日历事件
     */
    public static boolean addCalendarEvent(Context context, String title, String description, long reminderTime, long endTime, int previousDate) {
        if (context == null) {
            return false;
        }
        ...
        mCalendar.setTimeInMillis(endTime);//设置终止时间，开始时间加10分钟
...
//        values.put("minutes", 10); //提前10分钟提醒
//        values.put("method", 1);   //如果需要有提醒,必须要有这一行
