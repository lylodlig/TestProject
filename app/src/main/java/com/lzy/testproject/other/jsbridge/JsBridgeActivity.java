package com.lzy.testproject.other.jsbridge;
...
import com.lzy.testproject.other.jsbridge.bean.UserInfo;
...
//        mBridgeWebview.setWebViewClient(new MyWebViewClient(mBridgeWebview, JsBridgeActivity.this));
...
//        mBridgeWebview.setWebChromeClient(new JsBridgeActivity.MyChromeWebClient());
        ...
        mBridgeWebview.registerHandler("functionOpen", new BridgeHandler() {
            @Override
            public void handler(String data, CallBackFunction function) {
                Toast.makeText(JsBridgeActivity.this, "网页在打开你的文件预览", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void initListener() {
        btnCall.setOnClickListener(v -> {
            ...
            mBridgeWebview.callHandler("functionInJs", new Gson().toJson(new UserInfo("lzy", "123456")), new CallBackFunction() {
                @Override
                public void onCallBack(String data) {
    ...
    public class MyChromeWebClient extends WebChromeClient {
        ...
        public void openFileChooser(ValueCallback<Uri> uploadMsg) {
            ...
            i.setType("*/*");
            JsBridgeActivity.this.startActivityForResult(Intent.createChooser(i, "File Chooser"), FILECHOOSER_RESULTCODE);
        }
        ...
        public void openFileChooser(ValueCallback uploadMsg, String acceptType) {
            ...
            i.addCategory(Intent.CATEGORY_OPENABLE);
            i.setType("*/*");
            JsBridgeActivity.this.startActivityForResult(
        ...
        public void openFileChooser(ValueCallback<Uri> uploadMsg, String acceptType, String capture) {
            ...
            i.addCategory(Intent.CATEGORY_OPENABLE);
            i.setType("*/*");
            JsBridgeActivity.this.startActivityForResult(Intent.createChooser(i, "File Browser"), FILECHOOSER_RESULTCODE);
        }
