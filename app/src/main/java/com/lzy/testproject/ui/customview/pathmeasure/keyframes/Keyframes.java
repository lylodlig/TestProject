package com.lzy.testproject.ui.customview.pathmeasure.keyframes;
...
public class Keyframes {
    ...
    private void initPath(Path path) {
        ...
        do {
            ...
            mAngle = tmpAngle;
        } while (pathMeasure.nextContour());//跳转到下一条线
    }
